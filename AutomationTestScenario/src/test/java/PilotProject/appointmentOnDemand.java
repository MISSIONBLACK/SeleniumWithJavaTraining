// Need to check in other way, since pay is not loading
...
public class appointmentOnDemand extends TestBaseClass{
...
//					prop.getProperty("OnDemandDoctor"));
			...
			datePickerFromDropDownCalendar("dob_id", prop.getProperty("dob"));
